...
import { useMoviesDiscoverQuery, useMoviesQuery, useMoviesTypeQuery } from "../services/moviesApi";
...
const MovieList = () => {
    ...
    const { data: dataIdn = [], isLoading: idnIsLoading, isError: idnIsError } = useMoviesDiscoverQuery({'type':'movie', 'region':'id'});
